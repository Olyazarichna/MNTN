  ...
  return (
    <section className={styles.heroSection}>
      <div className={styles.navLink}>
        <p className={styles.navLinkText}>Follow us</p>
        <ul className={styles.list}>
          <li className={styles.listItem}>
            <a href="/" className={styles.link} target="_blank" rel="noreferrer noopener">
      ...
      <div className={styles.heroTextContainer}>
        <h3 className={styles.accentText}>A Hiking guide</h3>
        ...
        <li className={styles.listScroll}>
            <a className={styles.link} href='/' target='_blank' rel="noreferrer noopener">Start</a>
          </li>
          <li className={styles.listScroll}>
            <a className={styles.link} href='/' target='_blank' rel="noreferrer noopener">01</a>
          </li>
          <li className={styles.listScroll}>
            <a className={styles.link} href='/' target='_blank' rel="noreferrer noopener">02</a>
          </li>
          <li className={styles.listScroll}>
            <a className={styles.link} href='/' target='_blank' rel="noreferrer noopener">03</a>
          </li>
        </ul>

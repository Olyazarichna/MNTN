  ...
  return (
    <section className={styles.heroSection}>
      <div className={styles.navLink}>
        <p className={styles.navLinkText} id="contact">Follow us</p>
        <ul className={styles.list}>
          <li className={styles.listItem}>
            <Link href="/" className={styles.link} target="_blank" rel="noreferrer noopener">
      ...
      <div className={styles.heroTextContainer}>
        ...
        <li className={styles.listScroll}>
            <Link className={styles.link} href='/' >Start</Link>
          </li>
          <li className={styles.listScroll}>
            <Link className={styles.link} href='/#01'>01</Link>
          </li>
          <li className={styles.listScroll}>
            <Link className={styles.link} href='/#02'>02</Link>
          </li>
          <li className={styles.listScroll}>
            <Link className={styles.link} href='/#03'>03</Link>
          </li>
        </ul>
